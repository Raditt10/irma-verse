...
import { ArrowRight, CheckCircle2, Clock3, Hourglass, BookOpen, Sparkles, ChevronDown } from "lucide-react";
...
const OurPrograms = () => {
  ...
  // Hardcode user sementara untuk bypass loading check
  ...
  const fetchPrograms = async () => {
    try {
      const mockPrograms: Program[] = [
        {
          ...
          description: "Memahami hubungan akal dan wahyu dalam Islam dengan pendekatan modern.",
          duration: "3 bulan",
          level: "Kelas 10",
        ...
        },
        {
          ...
          description: "Menguasai bahasa Arab dasar untuk pemahaman kitab dan hadits sehari-hari.",
          duration: "6 bulan",
          level: "Kelas 11",
        ...
        },
        {
          ...
          description: "Pelatihan intensif public speaking dan fiqih shalat untuk calon imam muda.",
          duration: "2 bulan",
          level: "Kelas 12",
          quota: { filled: 15, total: 20 },
          status: "in-progress"
        },
        {
          id: "4",
          title: "Tahsin & Tajwid Intensif",
          description: "Memperbaiki bacaan Al-Quran dengan kaidah tajwid yang benar dan tartil.",
          duration: "4 bulan",
          level: "Kelas 10",
          quota: { filled: 28, total: 35 },
          status: "done"
        },
        {
          id: "5",
          title: "Manajemen Masjid Modern",
          description: "Strategi mengelola masjid dengan manajemen profesional dan teknologi terkini.",
          duration: "3 bulan",
          level: "Kelas 12",
          quota: { filled: 12, total: 20 },
          status: "upcoming"
        },
        {
          id: "6",
          title: "Media Dakwah Digital",
          description: "Belajar membuat konten dakwah kreatif untuk media sosial masa kini.",
          duration: "5 bulan",
          level: "Kelas 11",
          quota: { filled: 20, total: 25 },
          status: "upcoming"
        }
      ];
      ...
      mockPrograms.forEach((program, index) => {
        program.thumbnail = `https://picsum.photos/seed/program${index + 1}/400/250`;
      });
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="mb-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
              ...
              <div className="flex flex-wrap gap-2 text-xs font-bold">
                <div className="flex items-center gap-2 px-4 py-2 bg-amber-50 text-amber-700 rounded-xl border-2 border-amber-200 shadow-sm">
                  <Clock3 className="h-4 w-4" />
                  <span>Berlangsung</span>
                </div>
                <div className="flex items-center gap-2 px-4 py-2 bg-emerald-50 text-emerald-700 rounded-xl border-2 border-emerald-200 shadow-sm">
                  <CheckCircle2 className="h-4 w-4" />
                  <span>Selesai</span>
                </div>
                <div className="flex items-center gap-2 px-4 py-2 bg-slate-50 text-slate-600 rounded-xl border-2 border-slate-200 shadow-sm">
            ...
            <div className="mb-8 grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="relative" ref={dropdownRef}>
                ...
                {/* Dropdown Menu */}
                {isDropdownOpen && (
                  <div className="absolute top-full left-0 right-0 mt-2 z-20 bg-white border-2 border-slate-200 rounded-2xl shadow-[0_6px_0_0_#cbd5e1] overflow-hidden animate-in fade-in zoom-in-95 duration-200">
